...
public class Article {
    ...
    public Article(int Ref_articl, int Id_categorie, String Description, float Prix_article, String Marque) {
    ...
    public Article(int Id_categorie, String Description, float Prix_article, String Marque) {
        this.Id_categorie = Id_categorie;
        this.Description = Description;
        this.Prix_article = Prix_article;
        this.Marque = Marque;
    ...
    public String toString() {
        return "Article{" + "Ref_articl=" + Ref_articl + ", Id_categorie=" +
                ...
                ", Prix_article=" + Prix_article + ", Marque=" + Marque + '}';
    }
