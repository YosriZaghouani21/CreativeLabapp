...
public class MarketCoachController implements Initializable {
    ...
    private void setChosenFruit(Coach coach) {
        ...
        articlePriceLabel.setText(Sportify1.CURRENCY + coach.getPrixHeure());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        idcombo.getItems().add("Par Prix");
         ...
         System.out.println( Session.getUserStatic()+"Client en market client");
    ...
    private void hundelbutton(ActionEvent event) {
        try {
            ...
            fxmlLoader.setLocation(getClass().getResource("/sportify/views/FormulaireCoach.fxml"));
            fxmlLoader.load();
    ...
    private void updatearticle(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("/sportify/views/updateCoach.fxml"));
        fxmlLoader.load();
    ...
    public void showScreen() {
        ...
        try {
            for (int i = 0; i < listArt.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("/sportify/views/itemCoach.fxml"));
    ...
    private void ReserverCoach(ActionEvent event) {
     try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/sportify/views/reservationFXML.fxml"));
    ...
    private void statistique(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/sportify/views/Chart.fxml"));
