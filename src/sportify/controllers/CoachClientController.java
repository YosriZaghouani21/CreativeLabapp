...
public class CoachClientController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        idcombo.getItems().add("Par Prenom");
         ...
         System.out.println( Session.getUserStatic()+"Client en coach client");
    }

    private void hundelbutton(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/sportify/views/FormulaireCoach.fxml"));
    ...
    private void ReserverCoach(ActionEvent event) {
     try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/sportify/views/reservationPartieClient.fxml"));
            Parent root1 = (Parent) fxmlLoader.load();
            Stage stage = new Stage();
            stage.initModality(Modality.APPLICATION_MODAL);
            stage.initStyle(StageStyle.UNDECORATED);
