...
public class MarketController implements Initializable {
    ...
    private void hundelbutton(ActionEvent event) {
        try {
            ...
            fxmlLoader.setLocation(getClass().getResource("../views/Article/Formulaire.fxml"));
            fxmlLoader.load();
    ...
    private void updatearticle(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("../views/Article/update.fxml"));
        fxmlLoader.load();
    ...
    public void showScreen() {
        ...
        try {
            for (int i = 0; i < listArt.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("../views/Article/item.fxml"));
    ...
    private void panierFunction(MouseEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(getClass().getResource("../views/Article/panier.fxml"));
            fxmlLoader.load();
            Parent p = fxmlLoader.getRoot();
            Stage stage = new Stage();
    ...
    private void retourbutton(ActionEvent event) throws IOException {
        ...
        Parent root=FXMLLoader.load(getClass().getResource("../views/Article/Categorieuser.fxml")); 
