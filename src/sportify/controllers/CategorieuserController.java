...
public class CategorieuserController implements Initializable {
    ...
    private void updatearticle(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("/sportify/views/Article/CatUpdate.fxml"));
        fxmlLoader.load();
    ...
    private void hundelbutton(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(getClass().getResource("/sportify/views/Article/Fromcat.fxml"));
            fxmlLoader.load();
            Parent p = fxmlLoader.getRoot();
            Stage stage = new Stage();
            stage.setTitle("ABC");
