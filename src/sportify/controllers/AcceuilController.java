...
public class AcceuilController implements Initializable {
    ...
    public void Commandeview() throws IOException{
        ...
        Parent root=FXMLLoader.load(getClass().getResource("../views/livraison/main.fxml")); 
    ...
    public void livraisonview() throws IOException{
        Stage primStage=new Stage(); 
        Parent root=FXMLLoader.load(getClass().getResource("../views/livraison/livraison.fxml")); 
