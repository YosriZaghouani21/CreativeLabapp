 ...
 */
    ...
    public void AddReservation(ReservationCoach reservation) throws SQLException{
        ...
        if(test==false){
        String req = "INSERT INTO `reservationcoach` (`id_coach`, `Id`,`Date_res`, `nbrHeur`,`PrixTotal`) VALUES ('"+
             reservation.getId_coach()+"','"+ reservation.getId()+ "','" +
    ...
    public void DeleteReservation(int RefRes)throws SQLException {
      ...
      public void modifierReservation(int RefRes ,int id_coach ,int Id,Date Date_res,int nbrHeur,float PrixTotal)throws SQLException {
    try {    
    String req="UPDATE reservationcoach SET RefRes='"+RefRes+"',id_coach='"+id_coach+"',Id='"+Id+
...
return res;
    ...
    public boolean VeriefReservation(ReservationCoach reservation) {
        boolean test = false;
        String req = "SELECT * FROM `reservationcoach` WHERE  id_coach="+reservation.getId_coach()+" and Id="+reservation.getId()+
    ...
    public void factureClient (ReservationCoach rv){
           ...
           String file_name="C:\\Users\\zagho\\Desktop\\Nouveau dossier\\facture.pdf" ;
     ...
     document.open () ;
        ...
        document.add (para);
                            ...
                            PdfPCell pdfCell3 = new PdfPCell(new Phrase("Date_Reservation"));
                              PdfPCell pdfCell4 = new PdfPCell(new Phrase("nombre_Heure"));
                              
                              PdfPCell pdfCell5 = new PdfPCell(new Phrase("Prix_totale"));
