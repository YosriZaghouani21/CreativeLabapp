...
public class ChartController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     public ObservableList buildData(){
        ...
        try {
        String requete3="select count(*) , NomEv from evenement z join categorieevenement r where r.idCategEv = z.idCategEv group by NomEv";
            Statement st = DBconnector.getInstance().getCnx().createStatement();
...
//            Image img = Image.getInstance("C:\\xampp\\htdocs\\TunisiaBonPlan2-Integration\\web\\uploads\\images\\Sanstitre.png");
    ...
    private void retour(ActionEvent event) throws IOException {
       ...
       Parent root = FXMLLoader.load(getClass().getResource("/sportify/views/event/AfficherEv.fxml"));
